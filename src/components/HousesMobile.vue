      ...
      <section class="layout-mobile">
        ...
        <div class="top-bar-mobile">
              ...
              <div class="heading-mobile">
                ...
                <div class="sorting-mobile">
                  ...
                  <div class="search-barInput-mobile">
                    ...
                    <input type="text" placeholder="Search by City" class="search-bar-mobile input-field-mobile" v-model="searchQuery" />
            ...
            <div class="sort-buttons-mobile">
              <button class="sort-btn-price-mobile" :class="{ active: sortBy === 'price' }" @click="setSortCriteria('price')">
                Price
              </button>
              <button class="sort-btn-size-mobile" :class="{ active: sortBy === 'size' }" @click="setSortCriteria('size')">
                Size
              </button>
            </div>
          </div>
        ...
        <div class="houses-container-mobile">
          ...
          <div v-else class="noResults-mobile">
            <div class="noResultsContent-mobile">
